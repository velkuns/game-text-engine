...
class PlayerApiTest extends TestCase
{
    ...
    public function testLevelUp(): void
    {
        ...
        $playerApi->levelUp($attributes, ['skill' => ['Archery (Mastery)']], ['state' => ['poisoned']]);
        ...
        self::assertSame('poisoned', $playerApi->player->getAlterations()->getByType('state', 'poisoned')?->getName());
    ...
    public function testLevelUpButHaveError(
        ...
        $playerApi->levelUp($attributes, $traits, $alterations);
    }
    ...
    public static function getLevelUpDataProvider(): array
    {
        return [
            ...
            'no attribution allowed of this kind of trait'      => [
                ...
                'xp'          => 200,
                'attributes'  => ['strength' => 1, 'endurance' => 1, 'agility' => 1, 'intuition' => 1, 'vitality' => 1],
                'traits'      => ['skill' => ['Archery (Mastery)'], 'race' => ['Human']],
                'alterations' => ['state' => ['poisoned']],
                'exception'   => TraitsRulesException::class,
                'message'     => "Only 0 'race' allowed, 1 given.",
                'code'        => 2201,
            ],
            ...
            'new alteration not allowed on this level'          => [
                'level'       => 1,
                'xp'          => 100,
                'attributes'  => ['strength' => 1, 'endurance' => 1, 'agility' => 1, 'intuition' => 1, 'vitality' => 1],
                'traits'      => [],
                'alterations' => ['state' => ['poisoned']],
                'exception'   => AlterationsRulesException::class,
                'message'     => "New alterations only allowed every 2 level(s).",
                'code'        => 2400,
            ],
            'no attribution allowed of this kind of alteration' => [
                'level'       => 2,
                'xp'          => 200,
                'attributes'  => ['strength' => 1, 'endurance' => 1, 'agility' => 1, 'intuition' => 1, 'vitality' => 1],
                'traits'      => ['skill' => ['Archery (Mastery)']],
                'alterations' => ['state' => ['poisoned'], 'curse' => ['poisoned']],
                'exception'   => AlterationsRulesException::class,
                'message'     => "Only 0 'curse' allowed, 1 given.",
                'code'        => 2401,
            ],
            'remaining alteration of this kind to attribute'    => [
                'level'       => 2,
                'xp'          => 200,
                'attributes'  => ['strength' => 1, 'endurance' => 1, 'agility' => 1, 'intuition' => 1, 'vitality' => 1],
                'traits'      => ['skill' => ['Archery (Mastery)']],
                'alterations' => [],
                'exception'   => AlterationsRulesException::class,
                'message'     => "Remaining 1 alteration(s) of 'state' to attribute.",
                'code'        => 2402,
            ],
            'alteration not found'                              => [
                ...
                'attributes'  => ['strength' => 1, 'endurance' => 1, 'agility' => 1, 'intuition' => 1, 'vitality' => 1],
                'traits'      => ['skill' => ['Archery (Mastery)']],
                'alterations' => ['state' => ['poisoned (not exists)']],
                'exception'   => AlterationsRulesException::class,
                'message'     => "Alteration 'poisoned (not exists)' of type 'state' not found.",
                'code'        => 2500,
            ],
        ];
    }
